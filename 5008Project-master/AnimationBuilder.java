...
public interface AnimationBuilder<AnimationModel> {
  /**
   * Constructs a final document.
   * @return the newly constructed document
   */
  AnimationModel build();
   ...
   */
  AnimationBuilder<AnimationModel> setBounds(int x, int y, int width, int height);
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<AnimationModel> declareShape(String name, String type);
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<AnimationModel> addMotion(String name,
