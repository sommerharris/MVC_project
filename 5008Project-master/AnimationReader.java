...
public class AnimationReader {
   ...
   * @return
   */
  public static <AnimationModel> AnimationModel parseFile(Readable readable, AnimationBuilder<AnimationModel> builder) {
  ...
  private static <AnimationModel> void readCanvas(Scanner s, AnimationBuilder<AnimationModel> builder) {
    int[] vals = new int[4];
  ...
  private static <AnimationModel> void readShape(Scanner s, AnimationBuilder<AnimationModel> builder) {
    String name;
    String type;
    if (s.hasNext()) {
      name = s.next();
  ...
  private static <AnimationModel> void readMotion(Scanner s, AnimationBuilder<AnimationModel> builder) {
